...
// Most coded by WebFreak001, I code the ping part
var link = "wss://hack.chat/chat-ws";
...
var HackChatSession = (function (_super) {
    ...
    function HackChatSession(channel, username, password, options) {
        if (options === void 0) { options = { server: link }; }
        _super.call(this);
        this.channel = channel;
        if (password !== undefined)
            username += "#" + password;
        this.username = username;
        this.ws = new WebSocket(options.server || link);
